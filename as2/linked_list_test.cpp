...
const std::initializer_list<std::string> SAMPLE_PRIVATE{"I", "LOVE", "DATA","STRUCTURES", "AND", "ALGORITHMS"};
...
TEST(List, test_private_to_string_char) {
    List<std::string> list(SAMPLE_PRIVATE);
    EXPECT_EQ(list.to_string(), "{\"I\", \"LOVE\", \"DATA\", \"STRUCTURES\", \"AND\", \"ALGORITHMS\"}");
}
