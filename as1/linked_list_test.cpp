...
namespace {
TEST(List, return_head_value_test) {
    List list{2};
...
TEST(List, test_public_copy_constructor) {
    List list1{3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5, 8, 9, 7, 9, 3};
    List list2{ list1 };
    EXPECT_EQ(list2.to_string(), "{3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5, 8, 9, 7, 9, 3}");
